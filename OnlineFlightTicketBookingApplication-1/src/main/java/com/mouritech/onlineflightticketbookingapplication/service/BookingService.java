...
//	ResponseEntity<List<Booking>> getAllBookingByUserId(String userId) throws UserNotFoundException;
//
//
//
//	ResponseEntity<Booking> createBooking(String userId, Booking newBooking) throws UserNotFoundException;



	

//	Booking getBookingDateByUser(String userId, Date bookingDate) throws BookingDateAlreadyExistsException;

...
//	@Override
//	public ResponseEntity<List<Booking>> getAllBookingByUserId(String userId) throws UserNotFoundException {
//		if(!userRepository.existsById(userId)) {
//			throw new UserNotFoundException("User not found with id = "  + userId);
//		}
//		List<Booking> bokings = bookingRepository.findByUser(userId);
//		return new ResponseEntity<List<Booking>>(bokings,HttpStatus.OK);
//	}
//	@Override
//	public ResponseEntity<Booking> createBooking(String userId, Booking newBooking) throws UserNotFoundException {
//		
//		Booking booking = userRepository.findByUserId(userId).map(
//				user ->{
...
//	}
//	@Override
//	public Booking getBookingDateByUser(String userId, Date bookingDate) throws BookingDateAlreadyExistsException {
//		return 
